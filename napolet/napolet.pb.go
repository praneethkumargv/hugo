...
func (*MigrateVMRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d6dc1d0641a1c8f, []int{8}
}
...
func (m *MigrateVMRequest) GetVMId() string {
	if m != nil {
		return m.VMId
	}
	return ""
...
func (m *MigrateVMRequest) GetIPAddress() string {
	if m != nil {
		return m.IPAddress
	}
	return ""
...
func (*MigrateVMResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d6dc1d0641a1c8f, []int{9}
}
...
var fileDescriptor_6d6dc1d0641a1c8f = []byte{
	...
	,
}
...
func (c *pingClient) MigrateVM(ctx context.Context, in *MigrateVMRequest, opts ...grpc.CallOption) (*MigrateVMResponse, error) {
	out := new(MigrateVMResponse)
	err := c.cc.Invoke(ctx, "/Ping/MigrateVM", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedPingServer) MigrateVM(ctx context.Context, req *MigrateVMRequest) (*MigrateVMResponse, error) {
...
func _Ping_MigrateVM_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MigrateVMRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PingServer).MigrateVM(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Ping/MigrateVM",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServer).MigrateVM(ctx, req.(*MigrateVMRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Ping_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Ping_MigrateVM_Handler,
		},
	},
